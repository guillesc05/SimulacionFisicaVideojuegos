...
Bullet::Bullet(physx::PxVec3 pos, physx::PxVec3 velocity, ParticleSystem<CustomParticle>* bulletParticleSystem, physx::PxQuat rotation): PhysxParticle(pos, velocity,1,0)  {
