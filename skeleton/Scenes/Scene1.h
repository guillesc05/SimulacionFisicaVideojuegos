...
constexpr float CANNON_BALL_SIMULATED_VELOCITY = 50.f;
...
constexpr float TANK_BULLET_SIMULATED_VELOCITY = 300.f;
...
constexpr float PISTOL_BULLET_SIMULATED_VELOCITY = 100.f;
